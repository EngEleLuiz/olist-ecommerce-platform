...
st.markdown("<p style='color:#6B5B00;margin-top:-8px;'>BG/NBD + Gamma-Gamma lifetime value predictions</p>",
...
with col_r:
    ...
    fig.add_vline(x=median_spend, line_color=ORANGE, line_dash="dash",
                  annotation_text=f"Median R${median_spend:.0f}",
                  annotation_font_color=ORANGE)
    fig.update_xaxes(title_text="Total Spend (R$)")
    st.plotly_chart(_apply(fig, "Total Spend Distribution (clipped R$2k)"), use_container_width=True)
